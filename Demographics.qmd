...
Here we see that, while District 3 has a much higher proportion of people under 20, there are more children in District 5. Also, while District 5 had a higher percentage of 18-35 year olds, more people in this group live in Districts 6 and 7.
...
Let's take a look at the districts on a map. I'll first plot the percentage of the population under 20 years old, as well as the actual population. 
...
simplify_education <- function(df) {
  df %>%
    mutate(
      education = case_when(
        education %in% edu_levels[1:8]
        ~ "No HS Diploma",
        education %in% edu_levels[9:11]
